            ...
            <div class="row">
                ...
                <div class="col-lg-9">
                    <div class="header-top-left">
                        <ul class="phone-wrap">
                            <li><a href="tel: 0901234567">SĐT: 090.xxx.xnxx (Võ Ngọc Hiếu)</a></li>
                            <li><a href="{{route('lienhe')}}">Địa chỉ: 525A Điện Biên Phủ, TP Đà Nẵng</a></li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-3">
                    <div class="logo pb-sm-30 pb-xs-30">
                        <a href="{{ route('/') }}">
                            <img width="85%" src="{{ asset('img/logo/king1.png') }}" alt="">
                        </a>
                    </div>
                </div>
                        ...
                        <nav>
                            <ul>
                                ...
                                <li
                                    ...
                                    <a class="pl-20 pr-20" href="{{ url('danhsachsp?loaisp=0') }}">Điện Thoại</a>
                                    <ul class="megamenu hb-megamenu">
                                        ...
                                        <li>NHU CẦU SỬ DỤNG
                                            <ul>
                                                <li><a href="{{ url('danhsachsp') . '?loaisp=0&nhucau=sinhvien' }}">
                                                        Sinh Viên</a></li>
                                                <li><a href="{{ url('danhsachsp') . '?loaisp=0&nhucau=dohoa' }}">
                                                        Đồ Họa</a></li>
                                                <li><a href="{{ url('danhsachsp') . '?loaisp=0&nhucau=gaming' }}">
                                                        Gaming</a></li>
                                            </ul>
                                        </li>
                                    </ul>
